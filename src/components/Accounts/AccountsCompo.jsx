...
function AccountsCompo({ isLogin }) {
  ...
  const DeleteAccount = async (e) => {
    ...
    const auth = getAuth();
    const user = auth.currentUser;
    console.log('delete누른 뒤 auth: ', auth);
    console.log('delete누른 뒤 user: ', user);
...
//     // 추가: 새로운 로그인 인증 정보 받기
//     const reauthEmail = formState.email.value;
//     const reauthPassword = formState.password.value;
...
//         })
//         .catch((error) => {
//           console.log('API 회원 삭제 실패', error);
//         });
//     } else {
